...
tellraw @a ["[§bTPA§r] §a成功卸载. 使用 ", {"text":"§n/datapack enable \"file/TPA_datapack-2.0.5+mc1.15\"","clickEvent": {"action": "run_command","value": "/datapack enable \"file/TPA_datapack-2.0.5+mc1.15\""},"hoverEvent": {"action": "show_text","value": "点击运行命令"}},"来再次启用."]