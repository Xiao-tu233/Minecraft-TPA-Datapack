...
scoreboard objectives remove tpa.tpaccept_tgl
...
scoreboard objectives remove tpa.ext_menu
scoreboard objectives remove tpa.mute
scoreboard objectives remove tpa.search_id
scoreboard objectives remove tpa.search_id.ky
scoreboard objectives remove tpa.search_id.cl
...
data modify entity @e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words] Item.tag.header set from storage tpa:tpa loaded_lang.header
data modify entity @e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words] Item.tag.rmv_done_2 set from storage tpa:tpa loaded_lang.uninstall_rmv_done_2
data modify entity @e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words] Item.tag.done_leftpart set from storage tpa:tpa loaded_lang.uninstall_done_leftpart
data modify entity @e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words] Item.tag.done_hoverevent set from storage tpa:tpa loaded_lang.uninstall_done_hoverevent
data modify entity @e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words] Item.tag.done_rightpart set from storage tpa:tpa loaded_lang.uninstall_done_rightpart
...
tellraw @a [{"entity": "@e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words]", "nbt": "Item.tag.header"}, {"entity": "@e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words]", "nbt": "Item.tag.rmv_done_2"}]
function tpa:update_disable
tellraw @a [{"entity": "@e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words]", "nbt": "Item.tag.header"}, {"entity": "@e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words]", "nbt": "Item.tag.done_leftpart"}, {"text":"§n/datapack enable \"file/TPA_datapack-2.0.6+mc1.15.zip\"","clickEvent": {"action": "run_command","value": "/datapack enable \"file/TPA_datapack-2.0.6+mc1.15.zip\""},"hoverEvent": {"action": "show_text","value": {"entity": "@e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words]", "nbt": "Item.tag.done_hoverevent"}}}, {"entity": "@e[sort=nearest, limit=1, tag=tpa.uninstall.datapack_last_words]", "nbt": "Item.tag.done_rightpart"}, "."]
