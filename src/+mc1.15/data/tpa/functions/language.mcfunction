# tpa.slct_lang is dummy while tpa.language is trigger
...
execute if score #can_choose tpa.variables matches 0 run scoreboard players operation @s tpa.slct_lang = #language tpa.config
...
execute if score #can_choose tpa.variables matches 1 run scoreboard players operation @s tpa.slct_lang = #language tpa.variables
