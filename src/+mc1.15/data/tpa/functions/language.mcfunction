...
execute if score #can_choose tpa.variables matches 1 run tellraw @s[scores={tpa.output=1..2}] [{"storage": "tpa:tpa", "nbt": "temp.lang.header"}, {"storage": "tpa:tpa", "nbt": "temp.lang.lang_selected_left_part"}, {"storage": "tpa:tpa", "nbt": "temp.lang.name_display"}, {"storage": "tpa:tpa", "nbt": "temp.lang.lang_selected_right_part"}, "." ]
execute if score #can_choose tpa.variables matches 1 run title @s[scores={tpa.output=0..1}] actionbar [{"storage": "tpa:tpa", "nbt": "temp.lang.lang_selected_left_part"}, {"storage": "tpa:tpa", "nbt": "temp.lang.name_display"}, {"storage": "tpa:tpa", "nbt": "temp.lang.lang_selected_right_part"}]