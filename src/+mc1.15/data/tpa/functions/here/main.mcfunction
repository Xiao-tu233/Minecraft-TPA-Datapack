...
execute if score #is_1_16 tpa.config matches 1 run function tpa:here/dimension_check_1_16
execute if score #is_1_16 tpa.config matches 0 store result score #dim_num tpa.variables run data get entity @s Dimension
