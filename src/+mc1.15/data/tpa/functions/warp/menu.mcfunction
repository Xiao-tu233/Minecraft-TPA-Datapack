...
execute store result score #warp_disabledwarp_disabled tpa.variables run data get storage tpa:tpa temp.warp.disabled
...
execute if score #is_editting_warp tpa.variables matches 1 if score #editting_warp tpa.variables matches 1.. if score #warp_disabled tpa.variables matches 0 run tellraw @s ["  ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setpos", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setpos_hoverevent"}}, "clickEvent": {"action": "run_command","value": "/function tpa:warp/setpos"}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setname", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setname_hoverevent"}},"clickEvent": {"action": "suggest_command","value": "/data modify storage tpa:tpa temp.editted_warp.name set value \"\""}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setdesc", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setdesc_hoverevent"}},"clickEvent": {"action": "suggest_command","value": "/data modify storage tpa:tpa temp.editted_warp.desc set value \"\""}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_disable", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_disable_hoverevent"}},"clickEvent": {"action": "run_command","value": "/function tpa:warp/disable"}}, " ", {"storage": "tpa:tpa", "nbt": "warp[0].warp_button_apply", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_apply_hoverevent"}},"clickEvent": {"action": "run_command","value": "/function tpa:warp/remove"}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_rm", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_rm_hoverevent"}},"clickEvent": {"action": "run_command","value": "/function tpa:warp/remove"}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_cancel", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_cancel_hoverevent"}},"clickEvent": {"action": "run_command","value": "/function tpa:warp/remove"}}]
execute if score #is_editting_warp tpa.variables matches 1 if score #editting_warp tpa.variables matches 1.. if score #warp_disabled tpa.variables matches 1 run tellraw @s ["  ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setpos", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setpos_hoverevent"}}, "clickEvent": {"action": "run_command","value": "/function tpa:warp/setpos"}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setname", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setname_hoverevent"}},"clickEvent": {"action": "suggest_command","value": "/data modify storage tpa:tpa temp.editted_warp.name set value \"\""}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setdesc", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_setdesc_hoverevent"}},"clickEvent": {"action": "suggest_command","value": "/data modify storage tpa:tpa temp.editted_warp.desc set value \"\""}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_enable", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_enable_hoverevent"}},"clickEvent": {"action": "run_command","value": "/function tpa:warp/enable"}}, " ", {"storage": "tpa:tpa", "nbt": "warp[0].warp_button_apply", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_apply_hoverevent"}},"clickEvent": {"action": "run_command","value": "/function tpa:warp/remove"}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_rm", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_rm_hoverevent"}},"clickEvent": {"action": "run_command","value": "/function tpa:warp/remove"}}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_cancel", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.warp_button_cancel_hoverevent"}},"clickEvent": {"action": "run_command","value": "/function tpa:warp/remove"}}]
