...
data modify entity @e[limit=1, sort=nearest, type=minecraft:text_display,tag=tpa.text_display] text set value '{"storage":"tpa:tpa","nbt":"book.pages"}'
data modify storage tpa:tpa book.arg.pages set from entity @e[limit=1, sort=nearest, type=minecraft:text_display,tag=tpa.text_display] text
data modify storage tpa:tpa book.arg.pages set string storage tpa:tpa book.arg.pages 9 -2
