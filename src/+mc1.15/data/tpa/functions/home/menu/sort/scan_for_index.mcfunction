...
execute if score #i tpa.variables = #current_number tpa.variables run data modify storage tpa:tpa temp.home_sorted[-1] merge from storage tpa:tpa temp.home[0]
