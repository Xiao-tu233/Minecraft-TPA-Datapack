...
execute if score #destin_dimension tpa.variables matches 0 in minecraft:overworld as @e[sort=nearest, limit=1, tag=tpa.teleport_anchor] positioned as @s run tp ~ ~ ~
execute if score #destin_dimension tpa.variables matches -1 in minecraft:the_nether as @e[sort=nearest, limit=1, tag=tpa.teleport_anchor] positioned as @s run tp ~ ~ ~
execute if score #destin_dimension tpa.variables matches 1 in minecraft:the_end as @e[sort=nearest, limit=1, tag=tpa.teleport_anchor] positioned as @s run tp ~ ~ ~
