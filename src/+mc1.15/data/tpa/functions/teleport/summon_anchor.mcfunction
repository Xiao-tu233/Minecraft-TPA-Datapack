# Parent function: tpa:teleport/cal_sim_dist, tpa:teleport/summon_anchor(loop)
...
execute if entity @e[sort=nearest, limit=1, tag=tpa.teleport_anchor] run function tpa:teleport/summon_anchor