...
execute if score #tp_here tpa.variables = @s tpa.player_id run scoreboard players set #condition tpa.variables 3
execute if score #tp_to tpa.variables = @s tpa.player_id run scoreboard players set #condition tpa.variables 3
execute if score #tp_here tpa.variables = @s tpa.tp_to if score #tp_here tpa.variables matches 2.. run scoreboard players set #condition tpa.variables 4
