...
execute if score #is_carpet_installed tpa.variables matches 1 run scoreboard players set #carpet_fake_player_fix tpa.config 1
execute if score #is_carpet_installed tpa.variables matches 1 run return 0
