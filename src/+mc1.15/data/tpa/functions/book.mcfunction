...
execute if score #error_code tpa.variables matches 1 run tellraw @s[predicate=tpa:output/show_chatbar] [{"storage":"tpa:tpa", "nbt":"loaded_lang.header"}, {"storage":"tpa:tpa", "nbt":"loaded_lang.book_spec"}, ". "]
execute if score #error_code tpa.variables matches 1 run title @s[predicate=tpa:output/show_actionbar] actionbar [{"storage":"tpa:tpa", "nbt":"loaded_lang.book_spec", "color":"red"}]
execute if score #error_code tpa.variables matches 2 run tellraw @s[predicate=tpa:output/show_chatbar] [{"storage":"tpa:tpa", "nbt":"loaded_lang.header"}, {"storage":"tpa:tpa", "nbt":"loaded_lang.book_disabled"}, ". "]
execute if score #error_code tpa.variables matches 2 run title @s[predicate=tpa:output/show_actionbar] actionbar [{"storage":"tpa:tpa", "nbt":"loaded_lang.book_disabled", "color":"red"}]
execute if score #error_code tpa.variables matches 3 run tellraw @s[predicate=tpa:output/show_chatbar] [{"storage":"tpa:tpa", "nbt":"loaded_lang.header"}, {"storage":"tpa:tpa", "nbt":"loaded_lang.book_mainhand_busy"}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.book_reget", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.book_reget_hoverevent"} }, "clickEvent": {"action": "run_command", "value": "/trigger tpa.book" }}]
execute if score #error_code tpa.variables matches 3 run title @s[predicate=tpa:output/show_actionbar] actionbar [{"storage":"tpa:tpa", "nbt":"loaded_lang.book_mainhand_busy", "color":"red"}]
...
data modify storage tpa:tpa book.title set string storage tpa:tpa book.title 8 -1
