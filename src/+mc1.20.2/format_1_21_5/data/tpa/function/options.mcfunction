...
tellraw @s ["      §6- ", \
    {storage: "tpa:tpa", nbt: "loaded_lang.option_button_set", click_event:{action:"suggest_command",command:"/scoreboard players set #home tpa.config "}}]
...
tellraw @s ["      §6- ", \
    {storage: "tpa:tpa", nbt: "loaded_lang.option_button_set", click_event:{action:"suggest_command",command:"/scoreboard players set #tp_pos tpa.config "}}]
...
tellraw @s ["      §6- ", \
    {storage: "tpa:tpa", nbt: "loaded_lang.option_button_set", click_event:{action:"suggest_command",command:"/scoreboard players set #tp_pos_cooldown tpa.config "}}]
...
tellraw @s ["      §6- ", \
    {storage: "tpa:tpa", nbt: "loaded_lang.option_button_set", click_event:{action:"suggest_command",command:"/scoreboard players set #time_out tpa.config "}}]
...
tellraw @s ["      §6- ", \
    {storage: "tpa:tpa", nbt: "loaded_lang.option_button_set", click_event:{action:"suggest_command",command:"/scoreboard players set #idfix_cooldown tpa.config "}}]
