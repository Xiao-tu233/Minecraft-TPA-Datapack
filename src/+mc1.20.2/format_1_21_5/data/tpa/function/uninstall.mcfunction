...
tellraw @a [{entity: "@n[tag=tpa.uninstall.datapack_last_words]", nbt: "Item.components.\"minecraft:custom_data\".header"}, {entity: "@n[tag=tpa.uninstall.datapack_last_words]", nbt: "Item.components.\"minecraft:custom_data\".done_leftpart"}, {text:"§n/datapack enable \"file/TPA_datapack-2.0.6+mc1.20.2.zip\"",click_event: {action: "run_command", command: "/datapack enable \"file/TPA_datapack-2.0.6+mc1.20.2.zip\""},hover_event: {action: "show_text", value: {entity: "@n[tag=tpa.uninstall.datapack_last_words]", nbt: "Item.components.\"minecraft:custom_data\".done_hoverevent"}}}, {entity: "@n[tag=tpa.uninstall.datapack_last_words]", nbt: "Item.components.\"minecraft:custom_data\".done_rightpart"}, "."]
