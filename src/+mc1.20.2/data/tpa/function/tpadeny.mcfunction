...
execute if score #is_reqer_found tpa.variables matches 1 run tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.header"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpa_left_part"}, \
        {selector:"@p[tag=to_modify]",hover_event:{action:"show_text",value:{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpa_hoverevent"}}}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpa_right_part"}, ". " \
    ]
execute if score #is_reqer_found tpa.variables matches 1 run title @s[predicate=tpa:output/show_actionbar] actionbar [\
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpa_left_part", color: "gold"}, \
        {selector:"@p[tag=to_modify]"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpa_right_part", color: "gold"} \
    ]
execute if score #is_reqer_found tpa.variables matches 1 run tellraw @p[tag=to_modify, predicate=tpa:output/show_chatbar] [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.header"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpa_left_part"}, \
        {selector:"@s",hover_event:{action:"show_text",value:{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpa_hoverevent"}}}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpa_right_part"}, ". " \
    ]
execute if score #is_reqer_found tpa.variables matches 1 run title @p[tag=to_modify, predicate=tpa:output/show_actionbar] actionbar [\
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpa_left_part", color: "gold"}, \
        {selector:"@s"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpa_right_part", color: "gold"} \
    ]
...
execute if score #is_reqer_found tpa.variables matches 2 run tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.header"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpahere_left_part"}, \
        {selector:"@p[tag=to_modify]",hover_event:{action:"show_text",value:{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpahere_hoverevent"}}}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpahere_right_part"}, ". " \
    ]
execute if score #is_reqer_found tpa.variables matches 2 run title @s[predicate=tpa:output/show_actionbar] actionbar [\
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpahere_left_part", color: "gold"}, \
        {selector:"@p[tag=to_modify]"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.recver_deny_tpahere_right_part", color: "gold"} \
    ]
execute if score #is_reqer_found tpa.variables matches 2 run tellraw @p[tag=to_modify, predicate=tpa:output/show_chatbar] [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.header"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpahere_left_part"}, \
        {selector:"@s",hover_event:{action:"show_text",value:{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpahere_hoverevent"}}}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpahere_right_part"}, ". " \
    ]
execute if score #is_reqer_found tpa.variables matches 2 run title @p[tag=to_modify, predicate=tpa:output/show_actionbar] actionbar [\
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpahere_left_part", color: "gold"}, \
        {selector:"@s"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.reqer_deny_tpahere_right_part", color: "gold"} \
    ]
