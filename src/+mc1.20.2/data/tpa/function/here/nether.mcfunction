...
data modify storage tpa:tpa temp.args.dimension_before_trans set from storage tpa:tpa loaded_lang.here_nether_postion_hoverevent
data modify storage tpa:tpa temp.args.dimension_after_trans set from storage tpa:tpa loaded_lang.here_overworld_postion_hoverevent
