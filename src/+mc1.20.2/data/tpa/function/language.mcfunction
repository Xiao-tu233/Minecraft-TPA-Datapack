...
title @s[predicate=tpa:output/show_actionbar] actionbar [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.lang_selected_left_part"}, {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.name_display"}, {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.lang_selected_right_part"}]
