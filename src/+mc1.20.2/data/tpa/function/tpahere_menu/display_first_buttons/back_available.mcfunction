...
tellraw @s ["", \
    ...
    {text: "[", color: "white", click_event:{action:"run_command",command: "/trigger tpa.back"}, hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "temp.tpa_menu.back_button_hover"}}, extra: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.tpa_menu_back_button"}, {text: "]", color: "white"}]}, " " \
]
