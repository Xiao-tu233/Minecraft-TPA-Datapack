...
execute if score #home_migration.continue tpa.variables matches 1 store result storage tpa:tpa temp.update_home.id int 1 run scoreboard players get #home_migration.id
