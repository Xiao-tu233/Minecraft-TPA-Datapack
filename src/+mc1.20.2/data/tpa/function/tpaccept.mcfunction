scoreboard players operation #accept_index tpa.variables = @s tpa.tpaccept
execute if score #accept_index tpa.variables matches 0 run scoreboard players operation #accept_index tpa.variables = @s tpaccept
...
execute if score #recved_requests tpa.variables matches 2.. run function tpa:tpaccept/found_multiple
