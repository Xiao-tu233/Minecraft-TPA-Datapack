...
data modify storage tpa:tpa temp.output.langs set from storage tpa:tpa loaded_lang.home_not_found
...
data modify storage tpa:tpa temp.output.arg_hover set from storage tpa:tpa loaded_lang.home_not_found_hoverevent
