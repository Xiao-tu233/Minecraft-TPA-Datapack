...
execute if score #request_selector.setting tpa.variables matches 1 run data modify storage tpa:tpa request_selector.req[0] set from storage tpa:tpa temp.current_selector

data modify storage tpa:tpa request_selector.req append from storage tpa:tpa request_selector.req[0]
