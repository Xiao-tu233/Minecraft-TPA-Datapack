execute store result score #selector.direction tpa.variables run data get storage tpa:tpa temp.matched_selector.requests[0].direction
execute store result score #selector.recver tpa.variables run data get storage tpa:tpa temp.matched_selector.requests[0].recver
