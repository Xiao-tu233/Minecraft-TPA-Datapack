# Parent function: tpa:cancel_req/show_selector, tpa:cancel_req/update_menu
...
execute if data storage tpa:tpa temp.selector.requests[0] run function tpa:cancel_req/selector/request/loop
