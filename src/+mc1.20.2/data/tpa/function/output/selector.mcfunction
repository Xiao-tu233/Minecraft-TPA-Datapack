...
data modify storage tpa:tpa temp.output.selector_index append from storage tpa:tpa loaded_lang.reqer_cancel_selector_index[0]
...
data modify storage tpa:tpa temp.output.selector_index append from storage tpa:tpa loaded_lang.reqer_cancel_selector_index[1]
...
data modify storage tpa:tpa temp.output.selector_index append from storage tpa:tpa loaded_lang.reqer_cancel_selector_index[2]

tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage: "tpa:tpa", nbt: "temp.output.selector_index[]", separator: ""}]
tellraw @s[predicate=tpa:output/show_chatbar] ""
tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage: "tpa:tpa", nbt: "temp.output.teleporters[0]"}, " ▶ ", {interpret: true, storage: "tpa:tpa", nbt: "temp.output.destinations[0]"}, {color: "white", text: "         "}, {text: "[", extra: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel"}, "]"], click_event: {action: "run_command", command: "/trigger tpa.cancel_req set 3"}, hover_event: {action: "show_text", value: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel_hoverevent"}]}}]
tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage: "tpa:tpa", nbt: "temp.output.teleporters[1]"}, " ▶ ", {interpret: true, storage: "tpa:tpa", nbt: "temp.output.destinations[1]"}, {color: "white", text: "         "}, {text: "[", extra: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel"}, "]"], click_event: {action: "run_command", command: "/trigger tpa.cancel_req set 4"}, hover_event: {action: "show_text", value: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel_hoverevent"}]}}]
tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage: "tpa:tpa", nbt: "temp.output.teleporters[2]"}, " ▶ ", {interpret: true, storage: "tpa:tpa", nbt: "temp.output.destinations[2]"}, {color: "white", text: "         "}, {text: "[", extra: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel"}, "]"], click_event: {action: "run_command", command: "/trigger tpa.cancel_req set 5"}, hover_event: {action: "show_text", value: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel_hoverevent"}]}}]
tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage: "tpa:tpa", nbt: "temp.output.teleporters[3]"}, " ▶ ", {interpret: true, storage: "tpa:tpa", nbt: "temp.output.destinations[3]"}, {color: "white", text: "         "}, {text: "[", extra: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel"}, "]"], click_event: {action: "run_command", command: "/trigger tpa.cancel_req set 6"}, hover_event: {action: "show_text", value: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel_hoverevent"}]}}]
tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage: "tpa:tpa", nbt: "temp.output.teleporters[4]"}, " ▶ ", {interpret: true, storage: "tpa:tpa", nbt: "temp.output.destinations[4]"}, {color: "white", text: "         "}, {text: "[", extra: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel"}, "]"], click_event: {action: "run_command", command: "/trigger tpa.cancel_req set 7"}, hover_event: {action: "show_text", value: [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.reqer_req_button_cancel_hoverevent"}]}}]
