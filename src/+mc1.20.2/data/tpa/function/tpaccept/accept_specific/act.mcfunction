# Parent function: tpa:tpaccept/accept_specific

execute store result score #reqer tpa.variables run data get storage tpa:tpa temp.accepted_request.reqer
execute store result score #direction tpa.variables run data get storage tpa:tpa temp.accepted_request.direction
