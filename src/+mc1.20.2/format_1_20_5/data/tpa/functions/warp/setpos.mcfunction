...
tellraw @s [{"storage":"tpa:tpa", "nbt":"loaded_lang.header"}, \ 
    {"storage":"tpa:tpa", "nbt":"loaded_lang.warp_set_left_part"}, \ 
    {"storage":"tpa:tpa", "nbt":"temp.args.name"}, \ 
    {"storage":"tpa:tpa", "nbt":"loaded_lang.warp_set_middle_part"}, \
    {"storage":"tpa:tpa", "nbt":"temp.args.dimension"}, \
    {"storage":"tpa:tpa", "nbt":"loaded_lang.warp_set_position"}, \
    {"storage":"tpa:tpa", "nbt":"temp.args.x"}, " ", \ 
    {"storage":"tpa:tpa", "nbt":"temp.args.y"}, " ", \ 
    {"storage":"tpa:tpa", "nbt":"temp.args.z"}, " ", \ 
    {"storage":"tpa:tpa", "nbt":"loaded_lang.warp_set_right_part"}, "." \
]