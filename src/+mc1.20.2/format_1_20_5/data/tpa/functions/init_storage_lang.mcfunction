...
[\
    ...
    {\
        ...
        header: "[§bTPA§r] ", \
        back_act: "You have been teleported Back", \
        back_disabled: "§aBack§r is disabled by the server", \
        back_not_exist: "No previous location found", \
        back_spec: "Spectator mode players are not allowed to use §aBack§r", \
        book_check_missing: "TPA Book missing detected, reissued", \
        book_disabled: "§aTPA Book§r is disabled by the server", \
        book_incompatible: "§aTPA Book§r is incompatible with this game version", \
        book_lore: "§r§bRight-click to open the TPA Menu. Drop to refresh. Move to offhand to stop using.", \
        book_mainhand_busy: "Please empty your main hand to receive the TPA Book", \
        book_refresh: "You refreshed the §aTPA Menu Book§r", \
        book_reget: "[§bReacquire§r]", \
        book_reget_hoverevent: "§bClick to reacquire the TPA Book", \
        book_spec: "Spectator mode players are not allowed to use the §aTPA Book§r", \
        book_stacking: "Stacked TPA Books detected, extra copies have been confiscated", \
        book_stop: "You have stopped using the §aTPA Book§r. You can reacquire it in the TPA Menu", \
        book_title: "§r§bTPA Menu Book §a[Drop to Refresh]", \
        dimension_menu_button: "[§bDimension Option Menu§r]", \
        dimension_menu_button_hoverevent: "§bClick to modify dimensions", \
        dimension_overworld: "Overworld", \
        dimension_the_nether: "The Nether", \
        dimension_the_end: "The End", \
        dimension_unknown: "Unknown Dimension", \
        dimension_unknown_detected_leftpart: "Detected unknown dimension(", \
        dimension_unknown_detected_rightpart: "), please modify it in dimension menu: ", \
        extended_menu_incompatible: "§aExpand Menu§r isn't compatible with this version", \
        ...
        here_button_tpa_notavail_hoverevent: "§cPlayer is not allowed to be requested", \
        here_spec: "Spectators cannot §abroadcast location§r", \
        here_voxel_hoverevent: "§bClick to add VoxelMap waypoint", \
        here_xaero_hoverevent: "§6Click to add Xaero's Minimap waypoint", \
        home_act_left_part: "You have been teleported to Home #", \
        home_act_right_part: "", \
        home_create: "You have not created any Homes yet", \
        home_create_button: "[§aCreate§r]", \
        home_create_button_hoverevent: "§aClick to create a Home", \
        ...
        home_display_set_button_hoverevent: "§aClick to set this Home", \
        home_display_tp_button: "[§bTeleport§r]", \
        home_display_tp_button_hoverevent: "§bClick to teleport to this Home", \
        home_menu_title: "You currently have the following Home slots: ", \
        home_missing_hoverevent: "This Home has not been set yet", \
        home_not_found_left_part: "The Home #", \
        home_not_found_right_part: "does not exist", \
        home_out_of_range_left_part: "The Home #", \
        home_out_of_range_right_part: "exceeds the server limit", \
        home_spec: "Spectator mode players are not allowed to operate §aHome§r", \
        hoverevent_suggest_tip: "You should complete the command as: ", \
        idfix_act_hoverevent: "§bThis player triggered ID fix", \
        idfix_act_left_part: "", \
        idfix_act_right_part: "triggered §aIDFix§r, so that every players' IDs and previous locations have been reset", \
        idfix_cooldown: "§aIDFix§r is on cooldown", \
        idfix_disabled: "Server doesn't allow §aIDFix§r", \
        lang_button: "[§6Click to Select Lang§r]", \
        lang_button_hoverevent: "§bClick to open language menu", \
        lang_button_server: "[§66Click to Select Server Lang§r]", \
        lang_disabled: "Server doesn't allow §aPlayerLangSelection§r", \
        lang_menu_select_button: "[§aLoad Suggest Command§r]", \
        lang_menu_select_button_hoverevent: "§bClick to load suggest command at chat bar: ", \
        lang_menu_title: "You can select language below:", \
        lang_selected_left_part: "Your language has been switched to: ", \
        lang_selected_right_part: "", \
        lang_server_follow_left_part: "Since the Datapack Server Language hasn't been set, it'll be ", \
        lang_server_follow_right_part: " from now on", \
        load_add_objectives: "Adding 46 score board objectives... (1/6)", \
        load_added_objectives: "Added score board objectives successfully... (2/6)", \
        load_author: "This datapack is made by §6Xiao_tu233§r. ", \
        load_button_help: "[Help]", \
        load_button_help_hoverevent: "Click to view help", \
        load_button_license: "[License]", \
        load_button_license_hoverevent: "§bWhen using the TPA datapack, please comply with the open-source license published on GitHub. §bAt the same time, the author §l§ndo not recommend§r§b using this datapack on servers with §l§ncommercial purposes§r§b. §bTo avoid any misunderstanding, please read and fully understand the complete license before use.", \
        load_button_options: "[Options]", \
        load_button_options_hoverevent: "Click to modify the datapack options", \
        load_button_update: "[Update]", \
        load_button_update_hoverevent: "Click to start the datapack update guide", \
        load_copyright_claim: "Copyright © 2024-2026 Xiao_tu233.    This datapack is an open-source project licensed under the GPL-3.0.    The author does not recommend using it on servers for commercial purposes.    Click “[License]” below to view the full license text.", \
        load_date_check_left_part: "The current version was published on ", \
        ...
        load_date_check_right_part: ", please make sure to keep it up to date", \
        load_did_reset_scores: "Reset online player's scores successfully... (3/6)", \
        load_done: "§aDatapack reloaded:", \
        load_done_extra: " Extra Version ", \
        load_init_storage: "Initializing related command storage... (3/6)", \
        load_init_vars: "Initializing variables... (5/6)", \
        load_initted_storage: "Successfully initialized related command storage... (4/6)", \
        load_initted_vars: "Successfully initialized variables... (6/6)", \
        load_remove_tags: "Removing tags... (4/6)", \
        load_removed_tags: "Successfully removed tags... (5/6)", \
        load_reset_scores: " Reseting player's scores... (2/6)", \
        load_title: "§eReloading...", \
        load_version_hoverevent: "§bThis is the version of TPA Datapack, instead of Minecraft Version.", \
        load_welcome: "Welcome to use TPA Datapack! ", \
        mute_disable: "You have enabled §aDatapack sounds§r", \
        mute_enable: "You have §amuted§r datapack", \
        option_advenced_warn: "The settings below are advanced. Do not modify them unless you know what you are doing.", \
        option_advenced_tip: "Open debug mode to adjust more settings (advanced settings)", \
        option_anchor_search_retries: "Retry Times When Finding Anchors", \
        option_anchor_search_retries_hoverevent: "§bModify §aRetry Times When Finding Anchors §r(§6Unit: times §ror §6Ticks/Frequency §r) below, §bSetting this too high will increase the waiting time, while setting it too low may cause anchor misdetection or pollution.", \
        option_back: "Disable Back", \
        option_book: "Disable TPA Book", \
        option_button_disable: "§cDisable§r]", \
        option_button_enable: "§r[§aEnable§r", \
        option_button_help: "[§4Helpr]", \
        option_button_help_hoverevent: "§bClick to view help menu", \
        option_button_license: "[§4License§r]", \
        option_button_license_hoverevent: "§bWhen using the TPA datapack, please comply with the open-source license published on GitHub. §bAt the same time, the author §l§ndo not recommend§r§b using this datapack on servers with §l§ncommercial purposes§r§b. §bTo avoid any misunderstanding, please read and fully understand the complete license before use.", \
        option_button_notworking: "[§4Not Working§r]", \
        option_button_notworking_hoverevent: "§bClick here if the tick function is not running (the TPA menu cannot be opened).", \
        option_button_set: "§r[§aSet§r]", \
        option_button_uninstall: "[§4Uninstall§r]", \
        option_button_uninstall_hoverevent: "§4Click to §l§nuninstall§r§4 TPA Datapack! Consider if you really need!", \
        option_button_update: "[§4Update§r]", \
        option_button_update_hoverevent: "§bClick to start the datapack update guide", \
        option_carpet_disabled: "This feature needs Carpet Mod as dependency, however Carpet hasn't been installed in server. ", \
        option_carpet_fake_player_fix: "Carpet Mod Fake Player Fix", \
        option_carpet_fake_player_fix_incompatible: "Carpet Mod Fake Player Fix isn't incompatible with this version", \
        option_compact_ids: "If remove player's id slot when player's offline", \
        option_current_game_version: "Current detected game version", \
        option_debug_mode: "Debug mode", \
        option_debug_mode_hoverevent: "§bClick below to enable Debug Mode. This will display debugging information in chat to help troubleshoot issues, but may cause chat spam.  After enabling Debug Mode, you can reopen the Settings menu to access advanced options.", \
        option_dimension: "Compatible Dimensions", \
        option_dimension_button_add: "[§aAdd§r]", \
        option_dimension_button_add_hoverevent: "§bClick to add new dimensions", \
        option_dimension_button_edit_color: "[§aEdit Color§r]", \
        option_dimension_button_edit_color_hoverevent: "§bClick to edit the theme color for this dimension.    After clicking, enter either a standard 16-color name or a hex color code (#XXXXXX) at the end of the command, then press Enter.", \
        option_dimension_button_edit_id: "[§aEdit ID§r]", \
        option_dimension_button_edit_id_hoverevent: "§bClick to edit the dimension ID for this dimension.  After clicking, press the left arrow key, type the ID after the colon, and press Enter.", \
        option_dimension_button_edit_namespaceid: "[§aEdit Namespace ID§r]", \
        option_dimension_button_edit_namespaceid_hoverevent: "§bClick to edit the namespace ID for this dimension. (Click after pressing the left arrow key twice, fill in the namespace:id format, then press Enter.)", \
        option_dimension_button_edit_name: "[§aEdit Name§r]", \
        option_dimension_button_edit_name_hoverevent: "§bClick to edit the display name for this dimension. (Click after pressing the left arrow key twice, fill in the name, then press Enter.)", \
        option_dimension_button_remove: "[§cRemove§r]", \
        option_dimension_button_remove_hoverevent: "§bClick to remove this dimension", \
        option_dimension_button_remove_notavail_hoverevent: "§cOriginal dimensions cannot be removed", \
        option_dimension_hoverevent: "§bIn the button below, click to open the §aDimension Compatibility§6 menu §band the number on the right will be the currently compatible dimensions", \
        option_dimension_menu_title: "The server is compatible with the following dimensions: ", \
        option_dimension_number_hoverevent_leftpart: "§bThe server is currently compatible with ", \
        option_dimension_number_hoverevent_rightpart: " dimensions", \
        option_disabled: "§cDisabled§r", \
        option_enabled: "§aEnabled§r", \
        option_frequency: "Datapack Working Frequency", \
        option_frequency_hoverevent: "§bModify §aDatapack Working Frequency §r(§6Unit: 1 Tick = 1/20 Second§r) below, §bClick Disable to stop datapack's working temporarily. ", \
        option_game_version: "Game Version Datapack File is Compatible with", \
        option_home: "Home Amount Owns", \
        ...
        option_idfix_cooldown: "§bID fix cooldown", \
        ...
        option_lang: "§bServer Language", \
        option_lang_hoverevent: "§bEnter Language selecting menu below", \
        option_player_lang: "Allows Players to select language", \
        option_max_anchor_summons_attempts: "Max Anchor Summons Attempts", \
        option_max_anchor_summons_attempts_hoverevent: "§bModify §aMax Anchor Summons Attempts§r(§6单位: 次§r) below §b调节过大会增加卡顿和无效等待, 过小可能导致传送频繁失败", \
        option_search_id: "是否禁用搜索玩家编号", \
        option_sim_dist: "模拟距离", \
        option_sim_dist_button_cal: "[§a计算§r]", \
        option_sim_dist_hoverevent: "§bModify §a模拟距离 §r(§6单位: 区块§r)  请在点击前保证主世界原点模拟距离内没有玩家", \
        option_stricter_book_check: "更严格的传送书检测", \
        option_stricter_book_check_incompatible: "更严格的传送书检测不兼容该版本", \
        option_stricter_book_check_disabled: "本功能需要Bookshelf数据包作为依赖, 而服务器尚未安装Bookshelf数据包. ", \
        option_time_out: "传送请求超时时间", \
        option_time_out_hoverevent: "§bModify §a传送请求超时时间 §r(§6单位: 1 游戏刻 = 1/20 秒§r), §b填0来设置禁止传送 §b填-1来设置永不超时", \
        option_title_line1: "======================§bTPA§6 设置菜单§r=====================", \
        option_title_line2: "请在下方调整设置: (需重新呼出菜单以查看更改)", \
        option_tp_pos: "传送坐标允许半径", \
        option_tp_pos_cooldown: "传送坐标冷却时间", \
        option_tp_pos_cooldown_hoverevent: "§bModify §a冷却时间 §r(§6单位: 1 游戏刻 = 1/20 秒§r), §b填0来设置无冷却 §b填-1来设置禁止传送", \
        option_tp_pos_hoverevent: "§bModify §a传送坐标允许半径 §r(§6单位: 米§r), §b填0来设置禁止传送 §b填-1来设置不限制半径(不推荐)", \
        option_tp_spec: "允许传送旁观者", \
        option_server_calling: "Qing3 shi3yong4 Ke4hu4duan1, er2 bu2shi4 Kong4zhi4tai2 lai2 tiao2zheng3 she4zhi4!", \
        option_server_calling_comment: "§l§n§4这里是一个注释 因为上面的option_server_calling需要被控制台所显示 如果直接写汉字会被显示为乱码 这里使用拼音来进行表示", \
        option_uses_binary_teleport: "是否使用二分法传送", \
        ...
        update_step5_rightpart: " 如果出现未知的记分项 请从第3步开始检查 这可能是由数据包安装版本不正确或未知不正确所导致的 其他问题请咨询Xiao_tu233", \
        update_nextstep: "§b[下一步]", \
        warp_button_add: "[§aCreate Warp§r]", \
        warp_button_add_hoverevent: "§bClick to create a Warp at your current location", \
        warp_button_apply: "[§a应用§r]", \
        warp_button_apply_hoverevent: "§b点击应用所缓存的更改", \
        warp_button_cancel: "[§c取消§r]", \
        warp_button_cancel_hoverevent: "§b点击放弃所缓存的更改", \
        ...
        warp_button_setpos_hoverevent: "§b点击把该公共传送点设置到当前位置", \
        warp_desc_disabled: "§c该公共传送点已被禁用", \
        warp_disabled: "§aWarp§r is disabled by the server", \
        warp_menu_title: "The server has set up the following Warps: ", \
        warp_number: "Warp#", \
        warp_spec: "Spectator mode players are not allowed to teleport to §aWarps§r", \
    ...
    {\
        ...
        option_advenced_tip: "打开调试模式以调节更多设置(高级设置)", \
        option_anchor_search_retries: "寻找传送锚点的重试次数", \
        option_anchor_search_retries_hoverevent: "§bModify §a寻找传送锚点的重试次数 §r(§6单位: 次 §r或 §6游戏刻/运行频率 §r), §b调节过大会延长等待, 过小可能导致锚点误判或污染", \
        option_back: "禁止玩家返回上一位置", \
        option_book: "禁止玩家使用传送书", \
        option_button_disable: "§c禁用§r]", \
        option_button_enable: "§r[§a启用§r", \
        ...
        option_enabled: "§a启用§r", \
        option_frequency: "数据包运行频率", \
        option_frequency_hoverevent: "§bModify §a数据包运行频率 §r(§6单位: 1 游戏刻 = 1/20 秒§r), §b点击禁用来暂时停止数据包运作", \
        option_game_version: "数据包文件兼容的游戏版本", \
        option_home: "拥有传送点的个数", \
        option_home_hoverevent: "§bModify §a拥有传送点的个数 §r(§6单位: 个§r), §b填0来设置禁止传送点, §b填-1来设置不限制传送点的数量(不推荐)", \
        option_idfix_cooldown: "§bID修复冷却时间", \
        option_idfix_cooldown_hoverevent: "§bModify §aID修复冷却时间 §r(§6单位: 1 游戏刻 = 1/20 秒§r), §b填0来设置无冷却, 填-1来设置禁止ID修复", \
        option_lang: "服务器语言", \
        option_lang_hoverevent: "§b在下方进入语言选择菜单", \
        option_player_lang: "是否允许玩家语言选择", \
        option_max_anchor_summons_attempts: "传送锚点最大召唤尝试次数", \
        option_max_anchor_summons_attempts_hoverevent: "§bModify §a传送锚点最大召唤尝试次数 §r(§6单位: 次§r) §b调节过大会增加卡顿和无效等待, 过小可能导致传送频繁失败", \
        option_search_id: "是否禁用搜索玩家编号", \
        option_sim_dist: "模拟距离", \
        option_sim_dist_button_cal: "[§a计算§r]", \
        option_sim_dist_hoverevent: "§bModify §a模拟距离 §r(§6单位: 区块§r)  请在点击前保证主世界原点模拟距离内没有玩家", \
