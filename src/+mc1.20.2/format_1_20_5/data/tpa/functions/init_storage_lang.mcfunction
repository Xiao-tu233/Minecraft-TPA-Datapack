...
[\
    ...
    {\
        ...
        option_frequency_hoverevent: "§bModify §aDatapack Working Frequency §r(§6单位: 1 Tick = 1/20 Second§r) below, §bClick Disable to stop datapack's working temporarily. ", \
