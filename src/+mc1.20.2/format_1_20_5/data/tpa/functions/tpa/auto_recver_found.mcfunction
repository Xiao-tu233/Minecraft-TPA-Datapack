...
tellraw @p[tag=to_modify, predicate=tpa:output/show_chatbar] [{"storage":"tpa:tpa", "nbt":"loaded_lang.header"}, {"storage":"tpa:tpa", "nbt":"loaded_lang.recver_accept_auto_left_part"}, {"selector":"@s","hoverEvent":{"action":"show_text","value":{"storage":"tpa:tpa", "nbt":"loaded_lang.recver_accept_auto_hoverevent"}}}, {"storage":"tpa:tpa", "nbt":"loaded_lang.recver_accept_auto_right_part"}, ". " ]
