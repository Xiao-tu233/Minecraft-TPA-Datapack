...
data modify storage tpa:tpa temp.book.interaction_context.eyes_y set from entity @n[nbt={Item:{components:{"minecraft:custom_data":{isInterationEyesAnchor: 1b}}}}] Pos[1]
