...
tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.header"}, \
    ...
    {score:{name: "#home", objective: "tpa.variables"}}, \
    {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_act_right_part"}, ". " \
]

title @s[predicate=tpa:output/show_actionbar] actionbar [\
    {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_act_left_part", color: "gold"}, \
    {score:{name: "#home", objective: "tpa.variables"}, color: "gold"}, \
    {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_act_right_part", color: "gold"}\
]
