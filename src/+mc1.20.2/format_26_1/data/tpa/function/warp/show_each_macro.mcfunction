...
$execute if score #warp_disabled tpa.variables matches 0 if score #i tpa.variables matches 2.. run tellraw @s [\
    ...
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_setname", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_setname_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/edit_name {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_setdesc", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_setdesc_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/edit_desc {index: $(index)}"}}, " ", \
