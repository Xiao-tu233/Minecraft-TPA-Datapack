...
$execute if score #warp_disabled tpa.variables matches 0 if score #i tpa.variables matches 2.. run tellraw @s [\
    ...
    {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_tp", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_tp_hoverevent"}}, click_event: {action: "run_command", command: "/trigger tpa.warp set $(index)"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_setpos", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_setpos_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/setpos {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_setname", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_setname_hoverevent"}},click_event: {action: "suggest_command", command: "/function tpa:warp/set_name {index: $(index), name: \"\"}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_setdesc", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_setdesc_hoverevent"}},click_event: {action: "suggest_command", command: "/function tpa:warp/set_desc {index: $(index), desc: \"\"}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_rm", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_rm_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/remove {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_disable", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_disable_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/disable {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_moveup", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_moveup_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/moveup {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_movedown", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_movedown_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/movedown {index: $(index)}"}}, " " \
]
...
$execute if score #warp_disabled tpa.variables matches 1 if score #i tpa.variables matches 2.. run tellraw @s [\
    ...
    {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_tp", color: "gray", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_desc_disabled"}}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_setpos", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_setpos_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/setpos {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_setname", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_setname_hoverevent"}},click_event: {action: "suggest_command", command: "/function tpa:warp/set_name {index: $(index), name: \"\"}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_setdesc", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_setdesc_hoverevent"}},click_event: {action: "suggest_command", command: "/function tpa:warp/set_desc {index: $(index), desc: \"\"}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_rm", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_rm_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/remove {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_enable", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_disable_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/enable {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_moveup", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_moveup_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/moveup {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_movedown", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_movedown_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/movedown {index: $(index)}"}}, " " \
]
...
$execute if score #warp_disabled tpa.variables matches 0 if score #i tpa.variables matches 1 run tellraw @s [\
    ...
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_rm", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_rm_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/remove {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_disable", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_disable_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/disable {index: $(index)}"}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_moveup", color: "gray", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_moveup_notavail_hoverevent"}}}, " ", \
    {interpret: true, storage: "tpa:tpa", nbt: "warp[0].warp_button_movedown", hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.warp_button_movedown_hoverevent"}},click_event: {action: "run_command", command: "/function tpa:warp/movedown {index: $(index)}"}}, " " \
]
