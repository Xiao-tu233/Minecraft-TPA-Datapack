...
execute unless data storage tpa:tpa temp.home run tellraw @s[predicate=tpa:output/show_actionbar] [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.header"}, \
...
execute unless data storage tpa:tpa temp.home run title @s[predicate=tpa:output/show_actionbar] actionbar [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_create", color:"red"}]
...
execute if score #is_exist tpa.variables matches 0 \
    run tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.header"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_not_found_left_part"}, \
        {score:{name: "#home", objective: "tpa.variables"}, hover_event: {action: "show_text", value: {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_not_found_hoverevent"}}}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_not_found_right_part"}, ". " \
    ]
execute if score #is_exist tpa.variables matches 0 \
    run title @s[predicate=tpa:output/show_actionbar] actionbar [\
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_not_found_left_part", color: "red"}, \
        {score:{name: "#home", objective: "tpa.variables"}, color: "red", hover_event: {action: "show_text", value: {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_not_found_hoverevent"}}}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_not_found_right_part", color: "red"} \
    ]
...
tellraw @s[predicate=tpa:output/show_chatbar] [{interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.header"}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_remove_left_part"}, \
        {score:{name: "#home", objective: "tpa.variables"}, hover_event: {action: "show_text", value: {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_remove_hoverevent"}}}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_remove_right_part"}, ". " \
    ]
title @s[predicate=tpa:output/show_actionbar] actionbar [\
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_remove_left_part", color: "red"}, \
        {score:{name: "#home", objective: "tpa.variables"}, color: "red", hover_event: {action: "show_text", value: {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_remove_hoverevent"}}}, \
        {interpret: true, storage:"tpa:tpa", nbt:"loaded_lang.home_remove_right_part", color: "red"} \
    ]
