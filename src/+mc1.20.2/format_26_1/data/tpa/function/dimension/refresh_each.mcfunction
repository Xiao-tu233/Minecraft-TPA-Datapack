...
execute unless data storage tpa:tpa temp.option.dimension[0].name run tellraw @a [{interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.header"}, {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.dimension_unknown_detected_leftpart"}, {interpret: true, storage: "tpa:tpa", nbt: "temp.option.dimension[0].namespaceid"}, ",", {interpret: true, storage: "tpa:tpa", nbt: "temp.option.dimension[0].id"}, {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.dimension_unknown_detected_rightpart"}, {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.dimension_menu_button", click_event:{action:"run_command",command: "/function tpa:dimension/menu"}, hover_event: {action: "show_text", value: {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.dimension_menu_button_hoverevent"}}}]
