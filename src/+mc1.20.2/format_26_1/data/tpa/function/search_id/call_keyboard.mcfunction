...
tellraw @s[predicate=tpa:output/show_chatbar] [\
    ...
    {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.search_id_name_input"}, \
    {interpret: true, storage: "tpa:tpa", nbt: "temp.search_id.input[]", separator: ""}, {text: " ", underlined: true}, \
    "\n", \
    {interpret: true, storage: "tpa:tpa", nbt: "loaded_lang.search_id_keyboard_title"}, \
    "\n", \
    ...
    "\n", \
    {interpret: true, storage: "tpa:tpa", nbt: "temp.args.capslock", hover_event: {action: "show_text", value: {text: "caps"}}, click_event:{action:"run_command",command: "/trigger tpa.search_id.key set 23"}}, " ", \
