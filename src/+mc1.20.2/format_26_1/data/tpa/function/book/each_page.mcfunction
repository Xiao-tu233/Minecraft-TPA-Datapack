...
execute if score #debug_mode tpa.config matches 1 run tellraw @a ["[§bTPA§r] §6 Debug: §rNow gotten page ",{score: {name: "#pages_current",objective: "tpa.variables"}}," content: §a",{interpret: true, storage:"tpa:tpa",nbt:"temp.book.lines"}]
