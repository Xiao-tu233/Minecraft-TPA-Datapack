...
tellraw @s[predicate=tpa:output/show_chatbar] [{"storage": "tpa:tpa", "nbt": "loaded_lang.header"}, {"storage": "tpa:tpa", "nbt": "loaded_lang.search_id_abort"}, " ", {"storage": "tpa:tpa", "nbt": "loaded_lang.search_id_recall", "clickEvent": {"action": "run_command", "value": "/trigger tpa.search_id"}, "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.search_id_recall_hoverevent"}}}]
