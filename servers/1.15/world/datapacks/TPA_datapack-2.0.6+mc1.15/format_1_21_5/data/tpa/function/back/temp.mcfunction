...
execute if score #debug_mode tpa.config matches 1 \
run tellraw @a ["[§bTPA§r] §6 Debug: §rNow showing: §adata storage tpa:tpa temp.back:§r",{storage:"tpa:tpa",nbt:"temp.back"}]