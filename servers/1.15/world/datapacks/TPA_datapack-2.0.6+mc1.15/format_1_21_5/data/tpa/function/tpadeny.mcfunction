...
execute if score #is_reqer_found tpa.variables matches 1 run tellraw @s[scores={tpa.output=1..2}] [{storage:"tpa:tpa", nbt:"temp.lang.header"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpa_left_part"}, \
        {selector:"@p[tag=to_modify]",hover_event:{action:"show_text","value":{storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpa_hoverevent"}}}, \
        {storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpa_right_part"}, ". " \
    ]
execute if score #is_reqer_found tpa.variables matches 1 run title @s[scores={tpa.output=0..1}] actionbar [\
        {storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpa_left_part", color: "gold"}, \
        {selector:"@p[tag=to_modify]"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpa_right_part", color: "gold"} \
    ]
execute if score #is_reqer_found tpa.variables matches 1 run tellraw @p[tag=to_modify, scores={tpa.output=1..2}] [{storage:"tpa:tpa", nbt:"temp.lang.header"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpa_left_part"}, \
        {selector:"@s",hover_event:{action:"show_text",value:{storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpa_hoverevent"}}}, \
        {storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpa_right_part"}, ". " \
    ]
execute if score #is_reqer_found tpa.variables matches 1 run title @p[tag=to_modify, scores={tpa.output=0..1}] actionbar [\
        {storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpa_left_part", color: "gold"}, \
        {selector:"@s"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpa_right_part", color: "gold"} \
    ]
...
execute if score #is_reqer_found tpa.variables matches 2 run tellraw @s[scores={tpa.output=1..2}] [{storage:"tpa:tpa", nbt:"temp.lang.header"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpahere_left_part"}, \
        {selector:"@p[tag=to_modify]",hover_event:{action:"show_text","value":{storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpahere_hoverevent"}}}, \
        {storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpahere_right_part"}, ". " \
    ]
execute if score #is_reqer_found tpa.variables matches 2 run title @s[scores={tpa.output=0..1}] actionbar [\
        {storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpahere_left_part", color: "gold"}, \
        {selector:"@p[tag=to_modify]"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.recver_deny_tpahere_right_part", color: "gold"} \
    ]
execute if score #is_reqer_found tpa.variables matches 2 run tellraw @p[tag=to_modify, scores={tpa.output=1..2}] [{storage:"tpa:tpa", nbt:"temp.lang.header"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpahere_left_part"}, \
        {selector:"@s",hover_event:{action:"show_text","value":{storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpahere_hoverevent"}}}, \
        {storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpahere_right_part"}, ". " \
    ]
execute if score #is_reqer_found tpa.variables matches 2 run title @p[tag=to_modify, scores={tpa.output=0..1}] actionbar [\
        {storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpahere_left_part", color: "gold"}, \
        {selector:"@s"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.reqer_deny_tpahere_right_part", color: "gold"} \
    ]
