...
data remove storage tpa:tpa temp.argss
...
execute unless data storage tpa:tpa temp.home run tellraw @s[scores={tpa.output=0..1}] [{storage:"tpa:tpa", nbt:"temp.lang.header"}, \
...
execute unless data storage tpa:tpa temp.home run title @s[scores={tpa.output=0..1}] actionbar [{storage:"tpa:tpa", nbt:"temp.lang.home_create", color:"red"}]
...
execute if score #is_exist tpa.variables matches 0 \
    run tellraw @s[scores={tpa.output=1..2}] [{storage:"tpa:tpa", nbt:"temp.lang.header"}, \
        {storage:"tpa:tpa", nbt:"temp.lang.home_not_found_left_part"}, \
        {score:{name: "#home", objective: "tpa.variables"}, hover_event: {action: "show_text", value: {storage:"tpa:tpa", nbt:"temp.lang.home_not_found_hoverevent"}}}, \
        {storage:"tpa:tpa", nbt:"temp.lang.home_not_found_right_part"}, ". " \
    ]
execute if score #is_exist tpa.variables matches 0 \
    run title @s[scores={tpa.output=0..1}] actionbar [\
        {storage:"tpa:tpa", nbt:"temp.lang.home_not_found_left_part", color: "red"}, \
        {score:{name: "#home", objective: "tpa.variables"}, color: "red", hover_event: {action: "show_text", value: {storage:"tpa:tpa", nbt:"temp.lang.home_not_found_hoverevent"}}}, \
        {storage:"tpa:tpa", nbt:"temp.lang.home_not_found_right_part", color: "red"} \
    ]
...
tellraw @s[scores={tpa.output=1..2}] [{storage:"tpa:tpa", nbt:"temp.lang.header"}, \
        ...
        {score:{name: "#home", objective: "tpa.variables"}, hover_event: {action: "show_text", value: {storage:"tpa:tpa", nbt:"temp.lang.home_remove_hoverevent"}}}, \
        {storage:"tpa:tpa", nbt:"temp.lang.home_remove_right_part"}, ". " \
    ]
title @s[scores={tpa.output=0..1}] actionbar [\
        {storage:"tpa:tpa", nbt:"temp.lang.home_remove_left_part", color: "red"}, \
        {score:{name: "#home", objective: "tpa.variables"}, color: "red", hover_event: {action: "show_text", value: {storage:"tpa:tpa", nbt:"temp.lang.home_remove_hoverevent"}}}, \
...
execute if score #home_owns tpa.variables matches 1 run return 0

# If length of home is 2.., compounds cannot be empty: remove the specific home with the given id
function tpa:home/remove with storage tpa:tpa temp.args
