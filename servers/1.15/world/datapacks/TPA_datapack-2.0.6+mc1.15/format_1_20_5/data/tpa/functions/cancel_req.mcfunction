...
execute if score #is_recver_found tpa.variables matches 0 \
    run tellraw @s[scores={tpa.output=1..2}] [{"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_no_req_found"}, ". " \
    ]
execute if score #is_recver_found tpa.variables matches 0 \
    run title @s[scores={tpa.output=0..1}] actionbar [\
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_no_req_found", "color": "gold"} \
    ]
...
execute if score #is_recver_found tpa.variables matches 1..2 \
    run tellraw @s[scores={tpa.output=1..2}] [{"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_cancel_left_part"}, \
        {"selector":"@p[tag=to_modify]","hoverEvent":{"action":"show_text","value":{"storage":"tpa:tpa", "nbt":"temp.lang.reqer_cancel_hoverevent"}}}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_cancel_right_part"}, ". " \
    ]
execute if score #is_recver_found tpa.variables matches 1..2 \
    run title @s[scores={tpa.output=0..1}] actionbar [\
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_cancel_left_part", "color": "gold"}, \
        {"selector":"@p[tag=to_modify]"}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_cancel_right_part", "color": "gold"} \
    ]
execute if score #is_recver_found tpa.variables matches 1..2 \
