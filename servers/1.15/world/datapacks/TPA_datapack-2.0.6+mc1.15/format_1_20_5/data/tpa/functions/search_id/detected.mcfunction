...
execute if score #command_len tpa.variables matches 1 run tellraw @s[scores={tpa.output=1..2}] [\
    {"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
    {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_req_not_exist"}, "." \
]
execute if score #command_len tpa.variables matches 1 run title @s[scores={tpa.output=0..1}] actionbar [{"storage":"tpa:tpa", "nbt":"temp.lang.reqer_req_not_exist"}]
...
execute if score #has_illegal_char tpa.variables matches 1 run tellraw @s[scores={tpa.output=1..2}] [\
    {"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
    {"storage":"tpa:tpa", "nbt":"temp.lang.search_id_throw_on_invalid_char"}, "." \
]
execute if score #has_illegal_char tpa.variables matches 1 run title @s[scores={tpa.output=0..1}] actionbar [{"storage":"tpa:tpa", "nbt":"temp.lang.search_id_throw_on_invalid_char"}]
...
execute unless score #tp_to tpa.variables matches 2.. run tellraw @s[scores={tpa.output=1..2}] [\
    {"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
    {"storage":"tpa:tpa", "nbt":"temp.lang.search_id_unavail_player"}, "." \
]
execute unless score #tp_to tpa.variables matches 2.. run title @s[scores={tpa.output=0..1}] actionbar [{"storage":"tpa:tpa", "nbt":"temp.lang.search_id_unavail_player"}]
