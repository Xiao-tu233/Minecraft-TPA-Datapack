...
execute if score #is_exist tpa.variables matches 0 \
    run tellraw @s[scores={tpa.output=1..2}] [{"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
        ...
        {"score":{"name": "#home", "objective": "tpa.variables"}, "hoverEvent": {"action": "show_text", "value": {"storage":"tpa:tpa", "nbt":"temp.lang.home_not_found_hoverevent"}}}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.home_not_found_right_part"}, ". " \
    ]
execute if score #is_exist tpa.variables matches 0 \
    run title @s[scores={tpa.output=0..1}] actionbar [\
        {"storage":"tpa:tpa", "nbt":"temp.lang.home_not_found_left_part", "color": "red"}, \
        {"score":{"name": "#home", "objective": "tpa.variables"}, "color": "red", "hoverEvent": {"action": "show_text", "value": {"storage":"tpa:tpa", "nbt":"temp.lang.home_not_found_hoverevent"}}}, \
...
title @s[scores={tpa.output=0..1}] actionbar [\
        ...
        {"score":{"name": "#home", "objective": "tpa.variables"}, "color": "red", "hoverEvent": {"action": "show_text", "value": {"storage":"tpa:tpa", "nbt":"temp.lang.home_remove_hoverevent"}}}, \
