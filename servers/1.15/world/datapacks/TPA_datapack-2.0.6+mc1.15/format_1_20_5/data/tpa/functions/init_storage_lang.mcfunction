data modify storage tpa:tpa lang set value [{}, \
    {\
        ...
        home_set_the_nether: "§c下界", \
        home_set_the_end: "§e末地", \
        home_set_position: "坐标", \
        home_set_right_part: "", \
        home_spec: "旁观者模式玩家不允许操作§a传送点§r", \
        idfix_act_left_part: "", \
        idfix_act_hoverevent: "§b这名玩家使用了ID修复", \
        idfix_act_right_part: "使用了§aID修复§r, 所有玩家的数据包ID与上一位置已被重置", \
        idfix_cooldown: "§aID修复§r还在冷却中", \
        idfix_disabled: "服务器不允许§aID修复§r", \
        ...
        lang_disabled: "语言功能已禁用", \
        lang_selected_left_part: "你已切换语言到", \
        lang_selected_right_part: "", \
        lang_server_follow_left_part: "由于数据包服务端默认语言尚未设置, 现在它被设置为", \
        lang_server_follow_right_part: "", \
        load_title: "§e重载中...", \
        load_add_objectives: "正在添加42个记分项... (1/6)", \
        ...
        load_done: "§a数据包重载完成: §r1.20.2-1.21.6 完整版 ", \
        load_version_hoverevent: "§b这是TPA数据包的版本, 而不是Minecraft版本.", \
        load_welcome: "欢迎使用TPA数据包! ", \
        load_copyright_claim: "Copyright © 2024-2025 Xiao_tu233 保留所有权利. 不允许商业使用. 具体请点击下方\"[协议]\"按钮", \
        ...
        load_button_update_hoverevent: "点击开始更新数据包", \
        ...
        option_button_enable: "[§a启用§r", \
        option_button_disable: "§c禁用§r]", \
        option_button_set: "[§a设置§r]", \
        option_debug_mode: "调试模式", \
        option_tp_spec: "允许传送旁观者", \
        option_remove_offline: "是否在玩家离线后移除ID空位", \
        option_carpet_fake_player_fix: "Carpet模组假人修复", \
        option_back: "是否禁用返回上一位置", \
        option_search_id: "是否禁用搜索ID", \
        option_book: "是否禁用传送书", \
        ...
        option_frequency_hoverevent: "§b在下方更改§a数据包运行频率 §r(§6单位: 1 游戏刻 = 1/20 秒§r), §b填0来禁止数据包运行", \
        ...
        recver_recv_tpa_actionbar_right_part: "向你发送了一个传送请求, 点头3次以接受请求, 摇头3次以拒绝请求", \
        ...
        recver_recv_tpahere_actionbar_right_part: "向你发送了一个§l传送此处§r请求, 点头3次以接受请求, 摇头3次以拒绝请求", \
        ...
        reqer_change_chatbar_left_part: "你之前发送过了一个向", \
        ...
        reqer_change_actionbar_right_part: "发送了请求, 等待他接受, 摇头3次以取消请求", \
        reqer_deny_tpa_left_part: "正在传送你至", \
        reqer_deny_tpa_hoverevent: "§b拒绝了你的传送请求的玩家", \
        reqer_deny_tpa_right_part: "...", \
        reqer_deny_tpahere_left_part: "正在传送", \
        reqer_deny_tpahere_hoverevent: "§b拒绝了你的§l传送此处§r请求的玩家", \
        reqer_deny_tpahere_right_part: "至你...", \
        ...
        reqer_req_tpa_actionbar_right_part: "发送了一个传送请求. 等待他接受, 摇头3次以取消请求", \
        ...
        reqer_req_tpahere_actionbar_right_part: "发送了一个传送他到你的所在位置的请求. 等待他接受, 摇头3次以取消请求", \
        ...
        search_id_disabled: "服务器未启用§a搜索ID§r", \
        ...
        tp_pos_disabled: "服务器不允许§a传送坐标§r", \
        ...
        tpa_menu_title: "这是玩家游戏用户名和玩家数据包id, 点击id发送传送请求: ", \
        tpahere_menu_title: "这是玩家游戏用户名和玩家数据包id, 点击id发送§l传送此处§r请求: ", \
        tpa_menu_extend_hoverevent: "§b点击展开菜单", \
        tpa_menu_extend: "§b展开§r", \
        tpa_menu_you: "你", \
        tpa_menu_has_id_of: "的§a数据包ID§r是", \
        tpa_menu_idfix_button: "[§bID修复§r]", \
        tpa_menu_idfix_button_hoverevent: "§b如果你遇到两个相同玩家拥有同一id的问题, 你可以尝试这个修复. 此修复会重置所有玩家的id.", \
        tpa_menu_search_id_button: "[§b搜索ID§r]", \
        tpa_menu_search_id_button_hoverevent: "§b点击呼出聊天栏键盘输入tpa指令", \
        ...
        tpa_menu_pos_button_hoverevent: "§b点击呼出聊天栏键盘输入tpa指令", \
        tpa_menu_here_button: "[§b广播位置§r]", \
        tpa_menu_here_button_hoverevent: "§b点击广播你的位置", \
        tpa_menu_home_button: "[§b传送点菜单§r]", \
        tpa_menu_home_button_hoverevent: "§b点击打开传送点(home)菜单", \
        ...
        tick_not_working_cmdblk_name: "§r§b在合适的地方把它放下", \
    }, {\
        id: 2, \
        name: "en_us", \
        ...
        load_done: "§aData pack has been reloaded: §r1.20.2-1.21.6 Extra version ", \
        ...
        "load_done": "§a資料包重新載入完成: §r1.20.2-1.21.6 完整版 ", \
        ...
        "option_button_enable": "[§a啟用§r", \
        "option_button_disable": "§c停用§r]", \
        "option_button_set": "[§a設定§r]", \
        ...
        "recver_cancel_right_part": "取消了對你的請求", \
        ...
        "reqer_deny_tpa_left_part": "正在傳送你至", \
        "reqer_deny_tpa_hoverevent": "§b拒絕了你的傳送請求的玩家", \
        "reqer_deny_tpa_right_part": "...", \
        "reqer_deny_tpahere_left_part": "正在傳送", \
        ...
        "search_id_disabled": "伺服器未啟用§a搜尋ID§r", \
