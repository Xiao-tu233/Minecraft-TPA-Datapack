...
$execute if score #dim tpa.variables matches 1 run tellraw @s[scores={tpa.output=1..2}] [\
    ...
    {"storage": "tpa:tpa", "nbt": "temp.lang.home_display_tp_button", "hoverEvent": {"action": "show_text","value": {"storage": "tpa:tpa", "nbt": "temp.lang.home_display_tp_button_hoverevent"}},"clickEvent": {"action": "run_command","value": "/trigger tpa.home set $(id)"}}, " ", \
    {"storage": "tpa:tpa", "nbt": "temp.lang.home_display_rm_button", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "temp.lang.home_display_rm_button_hoverevent"}},"clickEvent": {"action": "run_command","value": "/trigger tpa.removehome set $(id)"}}, " ", \
    {"storage": "tpa:tpa", "nbt": "temp.lang.home_display_set_button", "hoverEvent": {"action": "show_text","value": {"storage": "tpa:tpa", "nbt": "temp.lang.home_display_set_button_hoverevent"}},"clickEvent": {"action": "run_command","value": "/trigger tpa.sethome set $(id)"}} \
]
