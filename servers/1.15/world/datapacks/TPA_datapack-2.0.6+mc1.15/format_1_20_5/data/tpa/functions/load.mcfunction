...
data modify storage tpa:tpa game_version set value "1.21"
...
tellraw @a [\
    ...
    {"storage": "tpa:tpa", "nbt": "version", "hoverEvent":{"action":"show_text","value":{"storage": "tpa:tpa", "nbt": "temp.lang.load_version_hoverevent"}}}\
]
...
tellraw @a [\
    {"storage": "tpa:tpa", "nbt": "temp.lang.header"}, \
    {"storage": "tpa:tpa", "nbt": "temp.lang.load_button_options", "color": "gold", "clickEvent":{"action":"run_command","value":"/function tpa:options"},"hoverEvent":{"action":"show_text","value":{"storage": "tpa:tpa", "nbt": "temp.lang.load_button_options_hoverevent"}}}," ",\
    {"storage": "tpa:tpa", "nbt": "temp.lang.load_button_help", "color": "gold", "clickEvent":{"action":"run_command","value":"/function tpa:help"},"hoverEvent":{"action":"show_text","value":{"storage": "tpa:tpa", "nbt": "temp.lang.load_button_help_hoverevent"}}}," ",\
    {"storage": "tpa:tpa", "nbt": "temp.lang.load_button_update", "color": "gold", "clickEvent":{"action":"run_command","value":"/function tpa:update"},"hoverEvent":{"action":"show_text","value":{"storage": "tpa:tpa", "nbt": "temp.lang.load_button_update_hoverevent"}}}," ",\
    {"storage": "tpa:tpa", "nbt": "temp.lang.load_button_license", "color": "gold", "clickEvent":{"action":"run_command","value":"/function tpa:license"},"hoverEvent":{"action":"show_text","value":{"storage": "tpa:tpa", "nbt": "temp.lang.load_button_license_hoverevent"}}}]
...
# Re-translate because more keys are missing 
