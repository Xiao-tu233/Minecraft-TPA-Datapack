...
execute if score #if_change tpa.variables matches 1 \
    run tellraw @s[scores={tpa.output=1..2}] [{"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
        ...
        {"selector": "@p[tag=temp_modify]", "hoverEvent":{"action":"show_text","value":{"storage":"tpa:tpa", "nbt":"temp.lang.reqer_change_hoverevent"}}},  \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_change_chatbar_middle_part"}, \
        {"selector": "@p[tag=to_modify]", "hoverEvent":{"action":"show_text","value":{"storage":"tpa:tpa", "nbt":"temp.lang.reqer_req_tpa_hoverevent"}}},  \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_change_chatbar_right_part"}, " ", \
        {\
            "storage":"tpa:tpa", \
            "nbt":"temp.lang.reqer_req_button_cancel", \
            "clickEvent": {"action":"run_command", "value":"/trigger tpa.cancel_req"}, \
            "hoverEvent":{"action":"show_text", "value":{"storage":"tpa:tpa", "nbt":"temp.lang.reqer_req_button_cancel_hoverevent"}}\
        }\
    ]
execute if score #if_change tpa.variables matches 1 \
...
execute if score #if_change tpa.variables matches 1 \
    run tellraw @p[tag=temp_modify, scores={tpa.output=1..2}] [{"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
        ...
        {"selector": "@s", "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "temp.lang.recver_cancel_hoverevent"}}},  \
...
execute if score #is_recver_found tpa.variables matches 2 \
    run tellraw @s[scores={tpa.output=1..2}] [{"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_accept_auto_left_part"}, \
        {"selector":"@p[tag=to_modify]","hoverEvent":{"action":"show_text","value":{"storage":"tpa:tpa", "nbt":"temp.lang.reqer_accept_auto_hoverevent"}}}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_accept_auto_right_part"}, ". " \
    ]
execute if score #is_recver_found tpa.variables matches 2 \
    run title @s[scores={tpa.output=0..1}] actionbar [\
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_accept_auto_left_part", "color": "gold"}, \
        {"selector":"@p[tag=to_modify]"}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.reqer_accept_auto_right_part", "color": "gold"} \
    ]
# ------ recver ------
execute if score #is_recver_found tpa.variables matches 2 \
    run tellraw @p[tag=to_modify, scores={tpa.output=1..2}] [{"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.recver_accept_auto_left_part"}, \
        {"selector":"@s","hoverEvent":{"action":"show_text","value":{"storage":"tpa:tpa", "nbt":"temp.lang.recver_accept_auto_hoverevent"}}}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.recver_accept_auto_right_part"}, ". " \
    ]
execute if score #is_recver_found tpa.variables matches 2 \
    run title @p[tag=to_modify, scores={tpa.output=0..1}] actionbar [\
        {"storage":"tpa:tpa", "nbt":"temp.lang.recver_accept_auto_left_part", "color": "gold"}, \
        {"selector":"@s"}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.recver_accept_auto_right_part", "color": "gold"} \
    ]
# ------ END auto accepted req teleport ------
...
execute if score #is_recver_found tpa.variables matches 1 \
    run tellraw @p[tag=to_modify, scores={tpa.output=1..2}] [{"storage":"tpa:tpa", "nbt":"temp.lang.header"}, \
        ...
        {"selector":"@s","hoverEvent":{"action":"show_text","value":{"storage":"tpa:tpa", "nbt":"temp.lang.recver_recv_tpa_hoverevent"}}}, \
        {"storage":"tpa:tpa", "nbt":"temp.lang.recver_recv_tpa_chatbar_right_part"}, \
        {\
            "storage":"tpa:tpa", \
            "nbt":"temp.lang.recver_recv_button_accept", \
            "clickEvent": {"action":"run_command", "value":"/trigger tpa.tpaccept set 1"}, \
            "hoverEvent":{"action":"show_text", "value":{"storage":"tpa:tpa", "nbt":"temp.lang.recver_recv_button_accept_hoverevent"}}\
        }, " ", \
        {\
            "storage":"tpa:tpa", \
            "nbt":"temp.lang.recver_recv_button_deny", \
            "clickEvent": {"action":"run_command", "value":"/trigger tpa.tpaccept set -1"}, \
            "hoverEvent":{"action":"show_text", "value":{"storage":"tpa:tpa", "nbt":"temp.lang.recver_recv_button_deny_hoverevent"}}\
        }\
    ]
execute if score #is_recver_found tpa.variables matches 1 \
    run title @p[tag=to_modify, scores={tpa.output=0..1}] actionbar [\
