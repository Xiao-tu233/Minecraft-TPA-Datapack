...
execute store result score #is_char_valid tpa.variables run function tpa:search_id/string_map with storage tpa:tpa temp.args
...
# Recursive call
function tpa:search_id/char_loop with storage tpa:tpa temp.args