...
tellraw @s ["", \
    {\
        ...
        "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.tpa_menu_tpaheremenu_button_hoverevent"}}\
    }, " ", {\
        "storage": "tpa:tpa", \
        ...
        "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.tpa_menu_lang_button_hoverevent"}}\
    }, " " \
]
tellraw @s ["", \
    {\
...
tellraw @s [\
    {\
        ...
        "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.tpa_menu_refresh_hoverevent"}} \
    }, " ", {\
        ...
        "hoverEvent": {"action": "show_text", "value": {"storage": "tpa:tpa", "nbt": "loaded_lang.tpa_menu_simplemenu_button_hoverevent"}}\
    }, " " \
]
