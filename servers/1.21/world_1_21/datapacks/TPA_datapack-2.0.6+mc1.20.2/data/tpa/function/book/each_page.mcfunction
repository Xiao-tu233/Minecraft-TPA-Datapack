...
data modify entity @n[type=minecraft:text_display,tag=tpa.text_display] text set value '{"storage":"tpa:tpa","nbt":"book.pages"}'
data modify storage tpa:tpa book.arg.pages set from entity @n[type=minecraft:text_display,tag=tpa.text_display] text
