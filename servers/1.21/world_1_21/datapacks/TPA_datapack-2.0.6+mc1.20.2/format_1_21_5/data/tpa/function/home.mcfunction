...
tellraw @s[scores={tpa.output=1..2}] [{storage:"tpa:tpa", nbt:"temp.lang.header"}, \
    {storage:"tpa:tpa", nbt:"temp.lang.home_act_left_part"}, \
    {score:{"name": "#home", "objective": "tpa.variables"}}, \
    {storage:"tpa:tpa", nbt:"temp.lang.home_act_right_part"}, ". " \
]

title @s[scores={tpa.output=0..1}] actionbar [\
    {storage:"tpa:tpa", nbt:"temp.lang.home_act_left_part", color: "gold"}, \
    {score:{"name": "#home", "objective": "tpa.variables"}, color: "gold"}, \
    {storage:"tpa:tpa", nbt:"temp.lang.home_act_right_part", color: "gold"}\
]
