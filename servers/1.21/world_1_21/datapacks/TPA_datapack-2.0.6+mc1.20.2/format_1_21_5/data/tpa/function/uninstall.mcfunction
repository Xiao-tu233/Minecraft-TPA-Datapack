...
tellraw @a ["[§bTPA§r] §a成功卸载. 使用 ", {text:"§n/datapack enable \"file/TPA_datapack-2.0.5+mc1.20.2\"",click_event: {action: "run_command", command: "/datapack enable \"file/TPA_datapack-2.0.5+mc1.20.2\""},hover_event: {action: "show_text", value: "点击运行命令"}},"来再次启用."]