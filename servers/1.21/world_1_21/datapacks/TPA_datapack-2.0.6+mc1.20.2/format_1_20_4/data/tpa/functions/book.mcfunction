...
data modify entity @e[limit=1, sort=nearest, type=minecraft:text_display,tag=tpa.text_display] text set value '{"storage":"tpa:tpa","nbt":"temp.lang.book_title"}'
data modify storage tpa:tpa book.title set from entity @e[limit=1, sort=nearest, type=minecraft:text_display,tag=tpa.text_display] text
data modify entity @e[limit=1, sort=nearest, type=minecraft:text_display,tag=tpa.text_display] text set value '{"storage":"tpa:tpa","nbt":"temp.lang.book_lore"}'
data modify storage tpa:tpa book.lore set from entity @e[limit=1, sort=nearest, type=minecraft:text_display,tag=tpa.text_display] text

function tpa:book/give with storage tpa:tpa book

kill @e[limit=1, sort=nearest, type=text_display, tag=tpa.text_display]
