data modify storage tpa:tpa lang set value [{}, \
    {\
        ...
        load_button_options_hoverevent: "点击更 改数据包配置", \
        ...
        option_stricter_book_check_incompatible: "§a更严格的传送书检测不兼容该版本", \
        ...
        recver_recv_tpa_actionbar_right_part: "向你发送了一个传送请求, 蹲下并点头3次以接受请求, 蹲下并摇头3次以拒绝请求", \
        ...
        recver_recv_tpahere_actionbar_right_part: "向你发送了一个§l传送此处§r请求, 蹲下并点头3次以接受请求, 蹲下并摇头3次以拒绝请求", \
