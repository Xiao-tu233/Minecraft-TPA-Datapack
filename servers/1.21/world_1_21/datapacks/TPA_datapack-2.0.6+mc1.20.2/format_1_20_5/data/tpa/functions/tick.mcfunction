...
# Head gesture detect: Shake/nod head while sneaking
execute as @a[predicate=tpa:output/show_actionbar, predicate=tpa:is_sneaking] run function tpa:head_gestures/main
execute as @a[predicate=!tpa:is_sneaking] run function tpa:head_gestures/clear_rotations
