...
tellraw @s ["  ", {storage: "tpa:tpa", nbt: "loaded_lang.tp_pos_button_teleport", color: "green", click_event:{action:"run_command",command: "/trigger tpa.pos set -2"}}, " ", {storage: "tpa:tpa", nbt: "loaded_lang.tp_pos_button_abort", color: "red", click_event:{action:"run_command",command: "/trigger tpa.pos set -1"}}]