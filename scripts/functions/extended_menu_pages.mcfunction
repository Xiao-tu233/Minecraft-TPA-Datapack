...
$tellraw @s ["======================( ", \
{text:"§b<§r",click_event:{action:"run_command",command:"/trigger tpa.extended_menu set $(previous)"},hover_event:{action:"show_text",value:[{storage: "tpa:tpa", nbt: "loaded_lang.extended_menu_previous_page"},"§b($(previous))"]}}, \
{text:" $(page) ",click_event:{action:"suggest_command",command:"/trigger tpa.extended_menu set "}},\
{text:"§b>§r",click_event:{action:"run_command",command:"/trigger tpa.extended_menu set $(next)"},hover_event:{action:"show_text",value:[{storage: "tpa:tpa", nbt: "loaded_lang.extended_menu_next_page"},"§b($(next))"]}}, \
" )======================"]