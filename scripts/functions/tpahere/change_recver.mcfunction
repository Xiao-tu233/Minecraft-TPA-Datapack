...
tellraw @s[predicate=tpa:output/show_chatbar] [{storage:"tpa:tpa", nbt:"loaded_lang.header"}, {storage:"tpa:tpa", nbt:"loaded_lang.reqer_change_chatbar_left_part"}, {selector: "@p[tag=temp_modify]", hover_event:{action:"show_text",value:{storage:"tpa:tpa", nbt:"loaded_lang.reqer_change_hoverevent"}}},  {storage:"tpa:tpa", nbt:"loaded_lang.reqer_change_chatbar_middle_part"}, {selector: "@p[tag=to_modify]", hover_event:{action:"show_text",value:{storage:"tpa:tpa", nbt:"loaded_lang.reqer_req_tpahere_hoverevent"}}},  {storage:"tpa:tpa", nbt:"loaded_lang.reqer_change_chatbar_right_part"}, " ", {storage:"tpa:tpa", nbt:"loaded_lang.reqer_req_button_cancel", click_event: {action:"run_command", command:"/trigger tpa.cancel_req"}, hover_event:{action:"show_text", value:{storage:"tpa:tpa", nbt:"loaded_lang.reqer_req_button_cancel_hoverevent"}}}]
