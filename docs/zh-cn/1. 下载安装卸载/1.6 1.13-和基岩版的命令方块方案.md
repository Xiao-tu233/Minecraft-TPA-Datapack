...
命令方块放置示意如下：  
![命令方块示意](/docs/assets/img/1.6_command_blocks.png)
...
![命令方块示意](/docs/assets/img//1.6_command_blocks_.png)
...
![命令方块示意](/docs/assets/img//1.6_command_blocks___.png)
...
最终命令方块放置示意如下：  
![命令方块示意](/docs/assets/img//1.6_command_blocks__.png)